module MazeRunner(
 ...
 //////////////////////////////////////
/// Pipeline Signals and flops      ///
//////////////////////////////////////
logic signed [11:0] lft_spd_pipe, rght_spd_pipe;
logic signed [11:0] dsrd_hdng_adj_pipe;

always_ff @(posedge clk, negedge rst_n) begin
  if (!rst_n) begin
   lft_spd_pipe <= 12'h000;
   rght_spd_pipe <= 12'h000;
   dsrd_hdng_adj_pipe <= 12'h000;
  end else begin
    lft_spd_pipe <= lft_spd;		
    rght_spd_pipe <= rght_spd;
    dsrd_hdng_adj_pipe <= dsrd_hdng_adj;
  end
end
  /////////////////////////////////////
  ...
  ///////////////////////////////			 
  PID iCNTRL(.clk(clk),.rst_n(rst_n),.moving(moving),.dsrd_hdng(dsrd_hdng_adj_pipe),.actl_hdng(actl_hdng),
  ...
  /////////////////////////////////  
  MtrDrv iMTR(.clk(clk),.rst_n(rst_n),.lft_spd(lft_spd_pipe),.rght_spd(rght_spd_pipe),
