...
module Real_MazeRunner_tb();
  ...
  wire TX_RX, RX_TX; //UART wrapper connections for communication between iDUT and iCMD
  wire INRT_SS_n, INRT_SCLK, INRT_MOSI, INRT_MISO, INRT_INT; //SPI signals for inert intf
